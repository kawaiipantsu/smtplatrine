...
$logger->logDebugMessage("Overview page loaded by ".$_SERVER['REMOTE_ADDR']);
...
if ( array_key_exists("emails",$_GET ) ) {
    $pageTitle = "📬 E-Mails overview";
    $pageChosen = "emails";
} else if ( array_key_exists("recipients",$_GET ) ) {
    $pageTitle = "📧 Recipients overview";
    $pageChosen = "recipients";
} else if ( array_key_exists("credentials",$_GET ) ) {
    $pageTitle = "🔐 Credentials overview";
    $pageChosen = "credentials";
} else if ( array_key_exists("attachments",$_GET ) ) {
    $pageTitle = "📂 Attachments overview";
    $pageChosen = "attachments";
} else if ( array_key_exists("clients",$_GET ) ) {
        ...
        <div class="child">
            <fieldset>
                ...
                <div class="content">
                    ...
                    <div class="main">
<?PHP
if ( $pageChosen && $pageChosen == "clients" ) {
?>
<div class="tablecontainer">
  <ul class="responsive-table">
    <li class="table-header">
        <div class="col col-1" data-label="-">Last seen</div>
        <div class="col col-2" data-label="-">IP address</div>
        <div class="col col-3" data-label="-">Reverse DNS</div>
        <div class="col col-4" data-label="-">Autonomous System (AS) name</div>
        <div class="col col-5" data-label="-"></div>
        <div class="col col-6" data-label="-">Country</div>
        <div class="col col-7" data-label="-">Conn seen</div>
    </li>
    <li class="table-row">
        ...
        <div class="col col-5" data-label="-">-</div>
        <div class="col col-6" data-label="-">-</div>
        <div class="col col-7" data-label="-">-</div>
    </li>
<?PHP
...
?>
    <li class="table-row">
        <div class="col col-1 faded" data-label="-"><?=htmlentities($seen)?></div>
        <div class="col col-2" data-label="-"><?=htmlentities($clientip)?></div>
        <div class="col col-3" data-label="-"><?=htmlentities($clienthost)?></div>
        <div class="col col-4" data-label="-"><?=htmlentities($clientas)?></div>
        <div class="col col-5" data-label="-"><?=$flagimg?></div>
        <div class="col col-6" data-label="-"><?=htmlentities($clientcountry)?></div>
        <div class="col col-7" data-label="-"><?=htmlentities($numseen)?></div>
    </li>
<?PHP
}
?>
...
<?PHP
    ...
    echo "<p>This is in it's very early stages of development, please check back later</p>";
}
